...
**Arjun (UAE/DTAA)**; **Priya (US/FATCA)** & **Sam (UK/HNI)** divergences noted.
...
**Priya divergence:** eligibility stage is make-or-break — she needs the *honest gate* (Path B
waitlist + PFIC disclosure), else churns at FATCA. **Sam divergence:** less friction-sensitive,
more "is my larger sum handled correctly" — lean trust cues + support access.
...
**Arjun divergence:** at fund detail / post, surface **DTAA 0% opportunity** (H2). **Sam
divergence:** wants consolidated + capital-gains/FTC export for his CA. **Priya:** may hit the
eligibility wall here — route to honest gate, not a failed order.
